...
return [
    ...
    */
    ...
    'logo' => '<b>DB</b>akery',
    'logo_img' => 'storage/product/icon.png',
        ...
        'Sweetalert2' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '//cdn.jsdelivr.net/npm/sweetalert2@11.10.4/dist/sweetalert2.all.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '//cdn.jsdelivr.net/npm/sweetalert2@11.10.4/dist/sweetalert2.min.css',
                ],
            ],
        ],
        'Toastr' => [
